...
class CatapushPluginIntentProvider(private val targetActivityClass: Class<out Activity>): ICatapushNotificationIntentProvider {
        ...
        fun handleIntent(intent: Intent) {
            ...
            if (intent.scheme == "catapush" && entity == "messages" && !id.isNullOrBlank()) {
                intent.getParcelableExtra<CatapushMessage>("message")?.apply {
                    CatapushPluginModule.handleNotificationTapped(this)
                }
            }
        }
    }
