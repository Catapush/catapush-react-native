...
export function CatapushMessageWidget(props) {
    ...
    const buildImageBox = () => {
        if (attachmentError != null) {
            return React.createElement(Text, null, attachmentError.toString());
        }
        else if (props.message.hasAttachment && attachmentUrl == null) {
            return React.createElement(ActivityIndicator, { size: 'small' });
        }
        else {
            return (React.createElement(Image, { style: styles.image, source: {
                    uri: attachmentUrl,
                } }));
        }
    };
    ...
    const buildReceivedMessage = () => {
        ...
        return (React.createElement(View, { style: styles.receivedMessageContainer },
            React.createElement(View, { style: bubbleStyle },
                props.message.hasAttachment && buildImageBox(),
                React.createElement(Text, { style: bodyStyle }, (_a = props.message.body) !== null && _a !== void 0 ? _a : ''),
                React.createElement(Text, { style: captionStyle }, formatMessageDate() + confirmedCheck()))));
    };
    const buildSentMessage = () => {
        ...
        return (React.createElement(View, { style: styles.sentMessageContainer },
            React.createElement(View, { style: bubbleStyle },
                props.message.hasAttachment && buildImageBox(),
                React.createElement(Text, { style: bodyStyle }, (_a = props.message.body) !== null && _a !== void 0 ? _a : ''),
                React.createElement(Text, { style: captionStyle }, formatMessageDate() + confirmedCheck()))));
